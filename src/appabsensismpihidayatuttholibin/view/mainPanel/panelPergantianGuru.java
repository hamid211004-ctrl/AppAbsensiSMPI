...
public class panelPergantianGuru extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "AB001", "01-01-2026", "Ahmad", "B. Indonesia", "1", "7A", "Membaca", "Budi", "Sakit"},
                {"2", "AB002", "01-01-2026", "Budi", "IPA", "5", "7A", "Merangkum", "Siti", "Acara Keluarga"},
                {"3", "AB003", "02-02-2026", "Caca", "IPS", "3", "8B", "Mengerjakan LKS", "Burhan", "Izin"},
                {"4", "AB004", "02-02-2026", "Faiza", "MTK", "2", "8B", "Latihan Soal", "Ahmad", "Sakit"}
            },
            new String [] {
                "No", "ID Pergantian", "Tanggal", "Nama Guru", "Mapel", "Jam ke", "Kelas", "Tugas/Materi yang diberikan", "Guru Pengganti", "Keterangan"
            }
        ) {

...
public class panelAbsensiManual extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(1).setHeaderValue("ID Absensi");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Tanggal");
            jTable1.getColumnModel().getColumn(3).setMinWidth(0);
            jTable1.getColumnModel().getColumn(3).setPreferredWidth(120);
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Nama");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Jenis Kelamin");
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Kelas");

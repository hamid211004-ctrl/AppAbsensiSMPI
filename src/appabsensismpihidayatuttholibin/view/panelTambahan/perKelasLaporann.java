 ...
 * @author ASUS
 */
public class perKelasLaporann extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(perKelasLaporann.class.getName());

    /**
     * Creates new form perKelasLaporann
     */
    public perKelasLaporann(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            .addGroup(panelUtamaLayout.createSequentialGroup()
                .addGroup(panelUtamaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelUtamaLayout.createSequentialGroup()
                        .addGap(29, 29, 29)
                        .addGroup(panelUtamaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jDateChooser1, javax.swing.GroupLayout.PREFERRED_SIZE, 410, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                perKelasLaporann dialog = new perKelasLaporann(new javax.swing.JFrame(), true);

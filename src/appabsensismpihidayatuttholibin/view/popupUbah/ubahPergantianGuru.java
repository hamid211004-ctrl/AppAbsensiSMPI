 ...
 * @author ASUS
 */
public class ubahPergantianGuru extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ubahPergantianGuru.class.getName());

    /**
     * Creates new form ubahPergantianGuru
     */
    public ubahPergantianGuru(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Ubah Data Pergantian Guru");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ubahPergantianGuru dialog = new ubahPergantianGuru(new javax.swing.JFrame(), true);
